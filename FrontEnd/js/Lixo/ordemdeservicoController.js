angular
  ...
  .controller(
    ...
    function ($scope, ordemDeServicoService, clienteService) {
      ...
      $scope.deleteOrdemDeServico = function (ordemDeServicoId) {
        ordemDeServicoService
          .deleteOrdemDeServico(ordemDeServicoId)
          .then(function (response) {
            console.log(response.data);
      ...
      $scope.concluirOrdemDeServico = function (ordemDeServicoId) {
        ordemDeServicoService
          .concluirOrdemDeServico(ordemDeServicoId)
          .then(function (response) {
            console.log(response.data);
          })
          .catch(function (error) {
